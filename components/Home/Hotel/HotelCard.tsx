...
// filepath: c:\Skills\WebDevelopment\next-js\travel_yt\components\Home\Hotel\HotelCard.tsx
    ...
    <div>
        ...
        <div>
            ...
            <div className='flex items-center space-x-2 '>
                <div className='px-2 py-2 bg-blue-800 rounded-md font-blue text-white text-xs'>{hotel.rating}</div>
                <div>
                ...
                <p className='mt-3 text-gray-700 font-medium '>
                    Starting from <span className='text-blue-600 font-bold'>${hotel.price}</span> per night
                </p>
            </div>
            </div>
        </div>
